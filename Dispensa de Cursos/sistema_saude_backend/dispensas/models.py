...
class Solicitacao(models.Model):
    ...
    anexo = models.FileField(upload_to='anexos/', null=True, blank=True, verbose_name="Comprovante/Anexo")
    ...
    status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, default="PENDENTE_GERENTE"
    )
...
class Departamento(models.Model):
    ...
    responsavel = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="departamentos_coordenados",
    )
...
class Setor(models.Model):
    ...
    departamento = models.ForeignKey(
        Departamento, on_delete=models.CASCADE, related_name="setores"
    )
    responsavel = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
